...
function initializeGoogleSignIn() {
    ...
    if (isGitHubPages) {
        // Для GitHub Pages
        clientId = '847891057280-7uq6pf0fjc1f8cdnqouf7cj2tkjnkm1b.apps.googleusercontent.com';
...
function handleAuthError(error) {
    ...
    authErrorState.details = error.message || error.type || 'Неизвестная ошибка';
    showAuthError();
}
    ...
    if (buttonContainer) {
        buttonContainer.innerHTML = `
            <div class="auth-error-message">
                ...
                <p>Проверьте настройки JavaScript Origins в Google Cloud Console:</p>
