  ...
  function injectHeaderStyles() {
    ...
    style.textContent = \`
      ...
      .home-button {
        ...
        height: 40px;
        margin-left: 1rem;
        background: linear-gradient(135deg, ${headerData.titleColor || '#ff69b4'}, ${headerData.titleColor ? headerData.titleColor + '80' : '#ff1493'});
        border-radius: 50%;
        text-decoration: none;
        transition: all 0.3s ease;
      ...
      .home-button:hover {
        ...
        background: linear-gradient(135deg, ${headerData.titleColor || '#ff69b4'}, #ff6b35);
      }
