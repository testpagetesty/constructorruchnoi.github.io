            ...
            if (sectionData.elements && updatedSections[sectionKey].elements) {
              ...
              sectionData.elements.forEach((jsonElement, jsonIndex) => {
                ...
                if (matchingElements.length > 0) {
                  console.log(`🎯 [AI Дизайн Система] Найдено ${matchingElements.length} элементов типа ${jsonElement.type} в секции ${sectionKey}`);
                  
                  // Применяем стили ко ВСЕМ элементам этого типа в данной секции
                  matchingElements.forEach((currentElement, elementIndex) => {
                    ...
                    console.log(`🎯 [AI Дизайн Система] Применяем стили к элементу ${jsonElement.type} #${elementIndex} в секции ${sectionKey}, общий индекс #${originalIndex}`);
                  ...
                  if (jsonElement.type === 'cta-section' && jsonElement.colorSettings) {
                    ...
                    console.log(`✅ [AI Дизайн Система] Обновленный элемент ${jsonElement.type} #${elementIndex}:`, updatedElement);
