...
const ImageCard = ({
  ...
  const getCardStyles = () => {
    ...
    const backgroundStyle = currentUseGradient 
      ...
      case 'outlined':
        return {
          card: {
            ...
            borderRadius: `${cardStyles.borderRadius || 8}px`,
            boxShadow: 'none'
          },
  ...
  const renderImage = () => {
    ...
    const imageStyles = {
      ...
      objectFit: 'cover',
      filter: cardStyles.imageFilter,
      opacity: cardStyles.imageOpacity,
      transition: 'all 0.3s ease'
    };
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              ...
              <TextField
                fullWidth
                type="number"
                value={cardStyles.imageOpacity}
                onChange={(e) => handleStyleChange('imageOpacity', parseFloat(e.target.value))}
            ...
            <Box sx={{ display: 'flex', gap: 2, mb: 2, flexWrap: 'wrap' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => setCurrentTitleColor(e.target.value)}
                  style={{
                    width: '40px',
                    height: '40px',
                    border: 'none',
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <input
                  ...
                  onChange={(e) => setCurrentContentColor(e.target.value)}
                  style={{
                    width: '40px',
                    height: '40px',
                    border: 'none',
