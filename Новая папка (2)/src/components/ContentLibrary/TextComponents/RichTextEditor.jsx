...
const RichTextEditor = ({ 
  ...
  }, [animationSettings, backgroundColor, textColor, titleColor]);
        ...
        >
          {showTitle && title && (
            <Typography 
              ...
              gutterBottom
              sx={{ 
                color: currentTitleColor || titleColor || '#fff',
                fontWeight: 'bold',
                mb: 2,
          ...
          <Box 
            ...
            sx={{
              color: currentTextColor || textColor || '#fff',
              fontSize: '16px',
              lineHeight: 1.6,
              cursor: 'pointer',
              position: 'relative',
              ...
              '& h1, & h2, & h3, & h4, & h5, & h6': {
                margin: '16px 0 8px 0',
                fontWeight: 'bold',
                color: currentTitleColor || titleColor || '#ffd700',
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
                ...
                <Box sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <input
                      type="color"
                      value={currentTitleColor || '#1976d2'}
                      onChange={(e) => {
                        setCurrentTitleColor(e.target.value);
                        if (onUpdate) {
